...
class AssetDeliveryService {
  ...
  static Future<String?> getAudioAssetsPath() async {
    try {
      debugPrint('MEAudio: invoking getAudioAssetsPath()');
      final String? path = await _channel.invokeMethod<String>('getAudioAssetsPath');
      debugPrint('MEAudio: getAudioAssetsPath() -> $path');
      return path;
    } on PlatformException catch (e) {
      debugPrint('MEAudio: getAudioAssetsPath() PlatformException code=${e.code} message=${e.message}');
